...
# def func(name):
#     print(name)
# USE CTRL + / to comment out a line or multiple lines high-lighted!!!
...
# whatevernum % 2 == 0:  REMEMBER how to tell odd or even!
...
while l < len(l_st):
    if l_st[l] == 'F':
        ...
        print('OHHH NO IT IS HERE!')
    else:
        print('Not an S or an F')
    print(l_st[l])
    l = l + 1
